...
// Define a FastMo class that inherits from the Object class
class FastMo: public RigidBody
{
public:
    // Constructor that initializes the ball object with a given position and rotation
    FastMo(SDL_Renderer* pRenderer, Vector2f position, double rotationDegrees = 0);
